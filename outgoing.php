                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="title_right">
                                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                                    <div class="input-group" style="float: right">
                                        <button type="button" class="btn btn-primary" id="gen_invoice"
                                            data-toggle="modal" data-target="#modal_invoice" disabled>Generate
                                            Receipt</button>
...
<div class="modal fade" id="modal_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12" style="padding: 30px">
                            Invoice From
                            <textarea id="invoice_from" required="required" class="form-control not_empty"
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12" style="padding: 30px">
                            Invoice To
                            <textarea id="invoice_to" required="required" class="form-control not_empty" name="message"
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12" style="padding: 30px">
                            ...
                            <div class="control-group">
                                ...
                                <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" id="invoice_date"
...
function show_invoice_for_edit() {
    ...
    $(".sel_invoice:checked").each(function() {
        ...
        invoice_items_list += '<tr class="itm_tr" id="itm_tr_' + id + '"><td>' + k + '</td> <td>' + item_nnn +
            '</td> <td><span id="qty_only_id_' + id + '">' + item_qttyy + '</span> ' + item_unniitt +
            '</td> <td><input type="text" class="untcst form-control not_empty" onkeypress="return isNumber(event)" id="unit_cost_entrd_' +
            id + '" ></td>  <td><input type="text" class="form-control" id="descr_' + id +
            '" ></td>  <td id="cal_lin_total_' + id +
            '" class="a_line_total" style="text-align: right; padding-right: 20px">0.00</td> </tr>';
        k++;
    });
    invoice_items_list +=
        '<tr><td colspan="5" style="text-align: right"><b>SUB-TOTAL</b></td> <td id="sub_total" style="text-align: right; padding-right: 20px">0.00</td> </tr>';
    invoice_items_list +=
        '<tr id="plus_tr"> <td colspan="6" style="text-align: right"><i class="fa fa-plus fa-fw fa-1x"  id="add_to_sub_total"></i></td> </tr>';
    invoice_items_list +=
        '<tr><td colspan="5" style="text-align: right"><b>GRAND TOTAL</b></td> <td id="grand_total" style="text-align: right; padding-right: 20px">0.00</td> </tr>';
                ...
                if (response.data.length > 0) {
                    ...
                    $.each(response['data'], function(i, v) {
                        ...
                        if (response['data'][i]['has_inv'] == "no") {
                            ...
                            strTable +=
                                '<td><input type="checkbox" name="sel_invoice" class="sel_invoice" id="sel_invoice_' +
                                response['data'][i]['list_id'] + '"></td>';
                        ...
                        strTable += '<td id="item_name_lz_' + response['data'][i]['list_id'] +
                            '">' + response['data'][i]['item_name'] + '</td>';
                        strTable += '<td>' + datestring + '</td>';
                        strTable += '<td>' + response['data'][i]['issued_to'] + '</td>';
                        // +response['data'][i]['Vendor']+
                        strTable += '<td id="qtyyty_' + response['data'][i]['list_id'] + '">' +
                            parseInt(response['data'][i]['qty']).toLocaleString() + '</td>';
                        strTable += '<td id="item_unniitt_' + response['data'][i]['list_id'] +
                            '">' + response['data'][i]['unit_name'] + '</td>';
                        // strTable += '<td>Pending</td>';
                        strTable +=
                            '<td valign="top"><a class="outgoing_info btn btn-primary btn-xs"  id="ou_' +
                            response['data'][i]['list_id'] +
                            '"><i  class="fa fa-folder"  data-toggle="tooltip" data-placement="top" title="View Incoming info"></i> View</a>';

                        strTable +=
                            '<i  class="fa fa-spinner fa-spin fa-1x fa-fw" aria-hidden="true" style="display: none;" id="loader11_' +
                            response['data'][i]['list_id'] + '"></i>&nbsp;&nbsp;';
