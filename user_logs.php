            ...
            if (response.status == '200') {
                ...
                if (response.data.length > 0) {
                    ...
                    $.each(response['data'], function(i, v) {
                        ...
                        strTable +=
                            '<td valign="top"><a class="delete_user  btn btn-danger btn-xs" style="cursor: pointer;" id="user_' +
                            response['data'][i]['user_id'] +
                            '"><i  class="fa fa-trash"  data-toggle="tooltip" data-placement="top" title="Delete User"></i> Delete</a>&nbsp;&nbsp;';

                        strTable += '<ahref="' + base_url + 'user_permissions?id=' + response[
                                'data'][i]['user_id'] +
                            '"><i  class="fa fa-lock"  data-toggle="tooltip" data-placement="top" title="User Permissions" style="font-size : 24px;"></i></a>&nbsp;&nbsp;';

                        strTable += '<a href="' + base_url + 'user_logs?id=' + response['data'][i][
                                'user_id'
                            ] +
