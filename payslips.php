...
?>
        ...
        <div class="modal fade" id="modal_view_payslip" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <script type="text/javascript">
          ...
          $.ajax({
            ...
            data: { "pay_id" : pay_id, "company_id" : company_id},
                        ...
                        if(response.data.length > 0){
                            ...
                            var monthNames = [
                             ...
                             var start = d.getDate()  + "/" +  monthNames[monthIndex] + "/" + d.getFullYear();
                              ...
                              strTable += '<td valign="top"><a class="payslip_info btn btn-primary btn-xs"  id="pay_'+response['data'][i]['pay_id']+'"><i  class="fa fa-folder"  data-toggle="tooltip" data-placement="top" title="View Payslip info"></i> View</a>';

                              strTable += '<i  class="fa fa-spinner fa-spin fa-1x fa-fw" aria-hidden="true" style="display: none;" id="loader_'+response['data'][i]['pay_id']+'"></i>&nbsp;&nbsp;';
