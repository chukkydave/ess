                        ...
                        <div class="x_content">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-3 col-xs-4">
                                    ...
                                    <input type="text" name="item_name" id="autocomplete-append"
            ...
            if (response.status == '200') {
                ...
                if (response.data.length > 0) {
                    ...
                    $.each(response['data'], function(i, v) {
                        ...
                        strTable +=
                            '<td valign="top"><a class="edit_item_icon btn btn-info btn-xs" id="item_' +
                            response['data'][i]['item_id'] +
                            '" style="cursor: pointer;"><i  class="fa fa-pencil"  data-toggle="tooltip" data-placement="top" title="Edit Item"></i> Edit</a>&nbsp;';

                        strTable +=
                            '<i  class="fa fa-spinner fa-spin fa-1x fa-fw" aria-hidden="true" style="display: none;" id="loader_' +
                            response['data'][i]['item_id'] + '"></i>&nbsp;&nbsp;';

                        strTable +=
                            '<a class="delete_item btn btn-danger btn-xs" style="cursor: pointer;" id="itm_' +
                            response['data'][i]['item_id'] +
                            '"><i  class="fa fa-trash-o"  data-toggle="tooltip" data-placement="top" title="Delete Item"></i> Delete</a>&nbsp;&nbsp;';

                        strTable += '<a href="' + base_url + 'items_activities?id=' + response[
                                'data'][i]['item_id'] +
                            '"><i  class="fa fa-clock-o"  data-toggle="tooltip" data-placement="top" style="color: #000; font-size: 20px;" title="View Item info"></i></a></td>';
