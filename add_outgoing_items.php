                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="issued_to">Issued
                                    to<span>*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
...
<!-- modal -->
<div class="modal fade" id="modal_outgoing" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
