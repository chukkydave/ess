...
?>
                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_start">Leave Start <span>*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="comment">Comment<span>*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            ...
                            <i class="fa fa-spinner fa-spin fa-fw fa-3x" style="display: none;" id="loading_app"></i>
                          </div>
                        </div>
      ...
      <div class="modal fade" id="modal_edit_leave" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header ">
              ...
              <div class="modal-body">
                ...
                <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="start_date">Start Date<span>*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="resumption_date" class="form-control col-md-7 col-xs-12 required1">
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="comment1">Comment<span>*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3" id="form_footer">
                      ...
                      <i class="fa fa-spinner fa-spin fa-fw fa-3x" style="display: none;" id="edit_leave_loader"></i>
        ...
        <div class="modal fade" id="modal_view_leave" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header ">
       ...
       <div class="modal fade" id="modal_leave" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <script type="text/javascript">
          ...
          $.ajax({
            ...
            data: { "leave_type" : leave_type, "comment" : comment, "company_id" : company_id, "leave_id" : leave_id, "employee_id" : employee_id, "leave_start" : leave_start, "resumption_date" : resumption_date},
          ...
          $.ajax({
            ...
            data: { "leave_id" : leave_id, "employee_id" : employee_id, "company_id" : company_id},
          ...
          $.ajax({
            ...
            data: { "leave_type" : leave_type, "leave_start" : leave_start, "company_id" : company_id, "employee_id" : employee_id, "resumption_date" : resumption_date, "comment" : comment},
          ...
          $.ajax({
            ...
            cache: false,
            url: api_path+"ess/view_leave_status",
            data: { "leave_id" : leave_id, "company_id" : company_id, "employee_id" : employee_id},
          ...
          function delete_leave(leave_id){
            ...
            $.ajax({ 
                ...
                data: {"company_id": company_id, "employee_id": employee_id, "leave_id" : leave_id},
                        ...
                        if(response.data.length > 0){
                            ...
                            var monthNames = [
                             ...
                             var finish = f.getDate()  + "/" +  monthNames[month] + "/" + f.getFullYear();
                              ...
                              strTable += '<td valign="top"><a class="leave_info btn btn-primary btn-xs"  id="lv_'+response['data'][i]['id']+'"><i  class="fa fa-folder"  data-toggle="tooltip" data-placement="top" title="View Leave info"></i> View</a>';

                              strTable += '<i  class="fa fa-spinner fa-spin fa-1x fa-fw" aria-hidden="true" style="display: none;" id="loader11_'+response['data'][i]['id']+'"></i>&nbsp;&nbsp;';


                              strTable += '<a class="edit_leave_icon btn btn-info btn-xs"id="leav_'+response['data'][i]['id']+'"><i  class="fa fa-pencil"  data-toggle="tooltip" data-placement="top" title="Edit Leave Type"></i> Edit</a>&nbsp;&nbsp;';

                              strTable += '<i  class="fa fa-spinner fa-spin fa-1x fa-fw" aria-hidden="true" style="display: none;" id="loader12_'+response['data'][i]['id']+'"></i>&nbsp;&nbsp;'; 

                              strTable +=  '<a class="delete_leave btn btn-danger btn-xs" style="cursor: pointer;" id="lev_'+response['data'][i]['id']+'"><i  class="fa fa-trash"  data-toggle="tooltip" data-placement="top" title="Delete Leave Type"></i> Delete</a></td>';
