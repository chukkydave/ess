                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control col-md-7 col-xs-12 required" id="sel_employee" name="sel_employee">
                            <option>-- Select --</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="notified">Notified
                                        Date<span>*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-prepend input-group">
                                            ...
                                            <input type="text" id="notified" required="required"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="lastday">Last
                                        day<span>*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-prepend input-group">
                                            <span class="add-on input-group-addon"><i
                                                    class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                            <input type="text" id="lastday" required="required"
                                                class="form-control col-md-7 col-xs-12 required">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <tr id="loading">
                                    <td colspan="8"><i class="fa fa-spinner fa-spin fa-fw fa-3x"
...
<div class="modal fade" id="modal_view_resignation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<!-- modal -->
<div class="modal fade" id="modal_resignation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header ">
...
<div class="modal fade" id="modal_edit_resign" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header ">
            ...
            <div class="modal-body">
                <div id="edit_form">
                    <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="notice_date">Notified
                                Date<span>*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last_day">Last
                                Day<span>*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            if (response.status == '200') {
                ...
                if (response.data.length > 0) {
                    ...
                    $.each(response['data'], function(i, v) {
                        ...
                        var monthIndex = d.getMonth();
                        var insert = d.getDate() + "/" + monthNames[monthIndex] + "/" + d
                            .getFullYear();

                        var monthIndex1 = td.getMonth();
                        var terminate = td.getDate() + "/" + monthNames[monthIndex1] + "/" + td
                            .getFullYear();
                        ...
                        strTable +=
                            '<td valign="top"><a class="resign_info btn btn-primary btn-xs"  id="rs_' +
                            response['data'][i]['id'] +
                            '"><i  class="fa fa-folder"  data-toggle="tooltip" data-placement="top" title="View Resignation info"></i> View</a>';
                        ...
                        strTable += '<a class="edit_resign_icon btn btn-info btn-xs"id="res_' +
                            response['data'][i]['id'] +
                            '"><i  class="fa fa-pencil"  data-toggle="tooltip" data-placement="top" title="Edit Resignation"></i> Edit</a>&nbsp;&nbsp;';
                        ...
                        strTable +=
                            '<a class="delete_resign btn btn-danger btn-xs" style="cursor: pointer;" id="resg_' +
                            response['data'][i]['id'] +
                            '"><i  class="fa fa-trash"  data-toggle="tooltip" data-placement="top" title="Delete Resignation"></i> Delete</a></td>';
