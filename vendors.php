                            ...
                            <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                        for="add_vendor_name">Vendor Name<span>*</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                        for="add_vendor_email">Vendor Email<span>*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                        for="add_vendor_address">Vendor Address<span>*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
...
<!-- modal -->
<div class="modal fade" id="modal_edit_vendor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header ">
            ...
            <div class="modal-body">
                ...
                <div id="edit_form">
                    <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="vendor_email">Vendor
                                Email<span>*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                for="vendor_phone">Phone<span>*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="vendor_address">Vendor
                                Address<span>*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
...
<!-- modal -->
<div class="modal fade" id="modal_view_vendor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header ">
            ...
            if (response.status == '200') {
                ...
                if (response.data.length > 0) {
                    ...
                    $.each(response['data'], function(i, v) {
                        ...
                        strTable += '<td valign="top">' + response['data'][i]['vendor_code'] +
                            '</td>';
                        strTable += '<td valign="top">' + status(response['data'][i][
                            'vendor_name'
                        ]) + '</td>';
                        strTable += '<td valign="top">' + response['data'][i]['vendor_address'] +
                            '</td>';
                        strTable += '<td valign="top">' + response['data'][i]['vendor_phone'] +
                            '</td>';
                        strTable += '<td valign="top">' + response['data'][i]['vendor_email'] +
                            '</td>';

                        strTable +=
                            '<td valign="top"><a class="vendor_info btn btn-primary btn-xs"  id="venIn_' +
                            response['data'][i]['vendor_id'] +
                            '"><i  class="fa fa-folder"  data-toggle="tooltip" data-placement="top" title="View Vendor info"></i> View</a>';

                        strTable +=
                            '<i  class="fa fa-spinner fa-spin fa-1x fa-fw" aria-hidden="true" style="display: none;" id="loader11_' +
                            response['data'][i]['vendor_id'] + '"></i>&nbsp;&nbsp;';

                        strTable += '<a class="edit_vendor_icon btn btn-info btn-xs" id="vend_' +
                            response['data'][i]['vendor_id'] +
                            '" style="cursor: pointer;"><i  class="fa fa-pencil"  data-toggle="tooltip" data-placement="top" title="Edit Vendor"></i> Edit</a>';
                        ...
                        strTable +=
                            '<a class="delete_vendor btn btn-danger btn-xs" style="cursor: pointer;" id="ven_' +
                            response['data'][i]['vendor_id'] +
                            '"><i  class="fa fa-trash-o"  data-toggle="tooltip" data-placement="top" title="Delete Vendor"></i> Delete</a></td>';
