                  ...
                  if (response.status == '200'){
                      ...
                      if(response.data.length > 0){
                          ...
                          $.each(response['data'], function (i, v) {
                              ...
                              strTable += '<td valign="top"><a class="warehouse_info btn btn-primary btn-xs" id="wareIn_'+response['data'][i]['warehouse_id']+'"><i  class="fa fa-folder"  data-toggle="tooltip" data-placement="top" title="View Warehouse info"></i> View</a>';
                              ...
                              strTable += '<a class="edit_warehouse_icon btn btn-info btn-xs" id="warh_'+response['data'][i]['warehouse_id']+'" style="cursor: pointer;"><i  class="fa fa-pencil"  data-toggle="tooltip" data-placement="top" title="Edit Warehouses"></i> Edit</a>';
                              ...
                              strTable +=  '<a class="delete_warehouse btn btn-danger btn-xs" style="cursor: pointer;" id="war_'+response['data'][i]['warehouse_id']+'"><i  class="fa fa-trash-o"  data-toggle="tooltip" data-placement="top" title="Delete Warehouse"></i> Delete</a>&nbsp;&nbsp;';

                              strTable += '<a href="'+base_url+'warehouse_activities?id='+response['data'][i]['warehouse_id']+'"><i  class="fa fa-clock-o"  data-toggle="tooltip" data-placement="top" style="color: #000; font-size: 20px;" title="View Warehouse info"></i></a></td>'; 
